...
int main(int argc, char *argv[])
{
    ...
    std::vector<Type*> shouldvec;
    //shouldvec.push_back(new IntType(32));
    FunctionType *type1 = new FunctionType(TypeSystem::intType, {});
    FunctionType *type2 = new FunctionType(TypeSystem::voidType, {});
    //FunctionType *type3 = new FunctionType(TypeSystem::intType, shouldvec);
    ...
    SymbolEntry *se3 = new IdentifierSymbolEntry(type1, "putint", identifiers->getLevel());
